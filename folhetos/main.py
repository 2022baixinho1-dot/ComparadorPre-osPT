...
def guardar_historico(flyer_url: str, produtos: list[dict]) -> str:
    ...
    # o Continente não publica datas de validade explícitas na fonte
    # que temos (só o texto do folheto) — assume-se uma semana corrida
    # (segunda a domingo), a partir da segunda-feira da semana ISO em
    # que o scraper corre. Pode falhar se alguma vez houver uma
    # promoção fora deste padrão (ex: campanha de fim de semana).
